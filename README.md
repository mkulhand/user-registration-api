...
We handles user registrations. To do so, user creates an account and we send a code by email to verify the account.
...
### services
Application services (authentication, mail adapter, database handler)
### use_cases
